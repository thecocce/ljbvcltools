...
Procedure Register;
Begin
  RegisterComponents('LjbTools', [TLjbMSNPopUp]);
End;

// component stuff

Function TLjbMSNPopUp.ShowPopUp: Boolean;
Var
  r: TRect;
...
// JWB
Procedure TLjbMSNPopUp.ClosePopUps;
Var
...
//Jiang Hong
Procedure TLjbMSNPopup.SetFont(Value: TFont);
Begin
...
//Jiang Hong
Procedure TLjbMSNPopup.SetHoverFont(Value: TFont);
Begin
...
//Jiang Hong
Procedure TLjbMSNPopup.SetTitleFont(Value: TFont);
Begin
...
Function TLjbMSNPopUp.GetCaptionFont: TFont;
Var
...
Constructor TLjbMSNPopUp.Create(AOwner: TComponent);
Begin
  Inherited;
...
Destructor TLjbMSNPopUp.Destroy;
Begin
  FFont.Free;
  FHoverFont.Free;
  FTitleFont.Free;
...
Function TLjbMSNPopup.GetEdge: Integer;
Var
  AppBar: TAppbarData;
Begin
  Result := -1;
...
Procedure TLjbMSNPopUp.SetBackground(Value: TBitmap);
Begin
