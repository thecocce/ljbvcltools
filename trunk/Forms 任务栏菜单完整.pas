...
{$ENDIF}
    ...
    SetWindowLong(FHandle,GWL_EXSTYLE,WS_EX_TOOLWINDOW); //Jack add
  end;
end;
...
begin
  ...
  begin
    ...
    SetWindowLong(FMainForm.Handle,GWL_EXSTYLE,WS_EX_APPWINDOW); // Jack add
    if (FMainForm.Caption='') then FMainForm.Caption:=Application.Title; // Jack add    
  end;
end;
...
begin
  //Modified by Riceball: Resource leak<maybe timer will not free!!> 
  StopHintTimer;
